...
const translationSettingsWindow = {
  ...
  de: i18n.create({
    values: {
      ...
      "settingsWindow_schemeWebpage": "Webseite",
      "settingsWindow_schemeWebpageBackground": "Hintergrund drucken",
      "settingsWindow_schemeWebpageLandscape": "Querformat",
      "settingsWindow_schemeWebpageSize": "Druckgröße",
      "A3": "A3 (297 x 420 mm)",
      "A4": "A4 (210 x 297 mm)",
      "A5": "A5 (148 x 210 mm)",
      "Legal": "Legal (216 x 356 mm)",
      "Letter": "Letter (216 x 279 mm)",
      "Tabloid": "Tabloid (279 x 432 mm)",
      "settingsWindow_schemeWebpageMarginTop": "Oberer Rand",
      "settingsWindow_schemeWebpageMarginBottom": "Unterer Rand",
      "settingsWindow_schemeWebpageMarginLeft": "Linker Rand",
      "settingsWindow_schemeWebpageMarginRight": "Rechter Rand",
      "0_marginNone": "ohne (0 mm)",
      "4_marginSmall": "klein (10 mm)",
      "8_marginMedium": "mittel (20 mm)",
      "16_marginLarge": "groß (40 mm)",
      "settingsWindow_schemeWebpageHeaderLeft": `Kopfzeile links <i class='fas fa-info-circle' title='folgende Platzhalter werden ersetzt:\n$t Titel der Webseite\n$u URL der Seite\n$p laufende Seitenzahl\n$P Gesamtseitenzahl\n$d Datum und Zeit als kompakter Zeitstempel (siehe Tab "Allgemein")\n$D Datum und Zeit als ausführlicher Zeitstempel'></i>`,
      "settingsWindow_schemeWebpageHeaderCenter": "Kopfzeile Mitte",
      "settingsWindow_schemeWebpageHeaderRight": "Kopfzeile rechts",
      "settingsWindow_schemeWebpageFooterLeft": "Fußzeile links",
      "settingsWindow_schemeWebpageFooterCenter": "Fußzeile Mitte",
      "settingsWindow_schemeWebpageFooterRight": "Fußzeile rechts",
  ...
  en: i18n.create({
    values: {
      ...
      "settingsWindow_schemeWebpage": "Webpage",
      "settingsWindow_schemeWebpageBackground": "Print background",
      "settingsWindow_schemeWebpageLandscape": "Landscape",
      "settingsWindow_schemeWebpageSize": "Print size",
      ...
      "settingsWindow_schemeWebpageMarginTop": "Top Margin",
      "settingsWindow_schemeWebpageMarginBottom": "Bottom Margin",
      "settingsWindow_schemeWebpageMarginLeft": "Left Margin",
      "settingsWindow_schemeWebpageMarginRight": "Right Margin",
      "0_marginNone": "none (0 in)",
      "4_marginSmall": "small (0.4 in)",
      "8_marginMedium": "medium (0.8 in)",
      "16_marginLarge": "large (1.6 in)",
      "settingsWindow_schemeWebpageHeaderLeft": `Header Left <i class='fas fa-info-circle' title='the following placeholders will be replaced:\n$t Title of the webpage\n$u URL of the page\n$p current page number\n$P total number of pages\n$d date and time as a compact timestamp (see tab "General")\n$D date and time as a detailed timestamp'></i>`,
      "settingsWindow_schemeWebpageHeaderCenter": "Header Center",
      "settingsWindow_schemeWebpageHeaderRight": "Header Right",
      "settingsWindow_schemeWebpageFooterLeft": "Footer Left",
      "settingsWindow_schemeWebpageFooterCenter": "Footer Center",
      "settingsWindow_schemeWebpageFooterRight": "Footer Right",
