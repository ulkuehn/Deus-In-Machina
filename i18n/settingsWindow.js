...
const translationSettingsWindow = {
  ...
  de: i18n.create({
    values: {
      ...
      "settingsWindow_exportTexts": "Textformat",
      "settingsWindow_exportTextSample": "Text für die Stilprobe",
      "settingsWindow_exportTextImage": "Bilder beschreiben",
      "settingsWindow_exportTableLineLength": "Tabellenbreite",
      "settingsWindow_exportMaps": "Landkarten",
  ...
  en: i18n.create({
    values: {
      ...
      "settingsWindow_exportTexts": "Text Format",
      ...
      "settingsWindow_exportMaps": "Maps",
