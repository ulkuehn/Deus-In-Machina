...
const translationMainProcess = {
  ...
  de: i18n.create({
    values: {
      ...
      mainProcess_fileTooLargeTitle: "Datei zu groß",
      mainProcess_fileTooLargeMessage: `Die Datei "%{path}" ist zu groß (maximal %{size} MB)`,
      rendererProcess_PDFTooLargeTitle: "PDF zu groß",
      rendererProcess_PDFTooLargeMessage: `Das erzeugte PDF ist zu groß (maximal %{size} MB)`,
  ...
  en: i18n.create({
    values: {
      ...
      mainProcess_fileTooLargeTitle: "File too large",
      mainProcess_fileTooLargeMessage: `File "%{path}" is too large (maximal %{size} MB)`,
      rendererProcess_PDFTooLargeTitle: "PDF too large",
      rendererProcess_PDFTooLargeMessage: `The PDF data is too large (maximal %{size} MB)`,
